#!/bin/bash
# SEC-005 — Opérateur | (rattrapage) : commande non autorisée rejetée
set -euo pipefail

# En v2, | est l'opérateur de rattrapage. Si test fail échoue,
# /bin/cat est tenté mais rejeté (domaine non autorisé)
